...
description: "Plan a scoped launch narrative, channels, assets, measurement, and follow-up from current evidence. Drafting does not publish, connect accounts, enable campaigns, or spend money."
...
metadata:
  source-workflow: "workflow.growth.launch-narrative-and-cadence"
