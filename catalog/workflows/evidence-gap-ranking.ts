 ...
 *
 * Paper / synthetic. No network. Consumes #522+#523. NO_527_IMPL cleared by #527. NO_528_IMPL cleared by #528. Does not implement #529.
 */
...
export const EVIDENCE_GAP_RANKING_RECIPE_NEXT_AFTER_CLOSE = "#529" as const;
