 ...
 *
 * Consumes #519+#521+#520+#522+#523 (+ #524 tip). NO_527_IMPL cleared by #527. NO_528_IMPL cleared by #528. NO_529_IMPL cleared by #529. #571 landed. Does not implement #511 closeout or #573.
 */
...
export const CHANGE_IMPACT_OBLIGATION_RECIPE_NEXT_AFTER_CLOSE = "#573" as const;
