 ...
 *
 * Consumes #519+#521+#520+#522+#523 (+ #524 tip). NO_527_IMPL cleared by #527. Does not implement #528–#529.
 */
...
export const CHANGE_IMPACT_OBLIGATION_RECIPE_NEXT_AFTER_CLOSE = "#528" as const;
