 ...
 * Consumes #514+#518+#519+#520+#521. NO_523_IMPL cleared by #523. Does not implement #524–#529.
 */
...
export const FEEDBACK_TO_WORK_SHADOW_RECIPE_NEXT_AFTER_CLOSE = "#524" as const;
