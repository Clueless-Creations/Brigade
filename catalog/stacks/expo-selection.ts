...
export const EXPO_REVIEWED_VERSION_FACTS: readonly ExpoVersionFact[] = [
  {
    ...
    notes: "SDK 57 changelog (2026). Patch expo@57.0.17 is cited there for React Native 0.86.3. Not an executed CLI. Reaffirmed researched 2026-09-19 (#81).",
  },
  {
    ...
    value: "0.86.3",
    evidenceTier: "researched",
    notes: "Paired with expo@57.0.17 in the SDK 57 changelog. Distinct from any workspace lock. Reaffirmed researched 2026-09-19 (#81).",
  },
  {
    component: "react",
    kind: "reviewed-baseline",
    value: "19.2",
    evidenceTier: "researched",
    notes: "Unchanged from SDK 56 according to the SDK 57 changelog. Reaffirmed researched 2026-09-19 (#81).",
  },
  {
    ...
    evidenceTier: "researched",
    notes: "Exact package version is a workspace pin. Do not take /latest/ docs as the installed Router. Reaffirmed researched 2026-09-19 (#81).",
  },
  {
    component: "expo-cli",
    kind: "reviewed-baseline",
    ...
    evidenceTier: "researched",
    notes: "Ships with the selected expo package. Global npm install is not implied. Reaffirmed researched 2026-09-19 (#81).",
  },
  {
    component: "eas-cli",
    kind: "reviewed-baseline",
    value: "unverified",
    evidenceTier: "researched",
    notes: "EAS CLI is a separate selection. No binary was executed during #81 intake. Reaffirmed researched 2026-09-19 (#81).",
  },
  {
    ...
    notes: "b2c-app-builder Node >=24 pin is not the Expo app SDK pin and not an EAS image. Reaffirmed 2026-09-19 (#81).",
  },
  {
    ...
    value: "36",
    evidenceTier: "researched",
    notes: "From published SDK 57 sdk-compatibility notes. Not a host observation. Reaffirmed researched 2026-09-19 (#81).",
  },
  {
  ...
  },
  {
    ...
    evidenceTier: "researched",
    notes: "@expo/sdk-compatibility samples mention Xcode 26.4 for 57.0.12. That is not proof of this host. Reaffirmed researched 2026-09-19 (#81).",
  },
];
