 ...
 * NO_524_IMPL cleared by #524. NO_525_IMPL cleared by #525. Does not implement #526–#529. Paper / synthetic fixtures only.
...
export const SEMANTIC_RUNTIME_SAFETY_NEXT_AFTER_CLOSE = "#526" as const;
