 ...
 * NO_521_IMPL cleared by #521. NO_522_IMPL cleared by #522. NO_523_IMPL cleared by #523. Does not implement #524–#529. Paper / synthetic fixtures only.
...
export const INFERENCE_RECEIPTS_NEXT_AFTER_CLOSE = "#524" as const;
