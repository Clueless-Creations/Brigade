 ...
 * NO_521_IMPL cleared by #521. NO_522_IMPL cleared by #522. Does not implement #523–#529. Paper / synthetic fixtures only.
...
export const INFERENCE_RECEIPTS_NEXT_AFTER_CLOSE = "#523" as const;
