 ...
 *
 * Consumes #518–#520. Does not redo them. NEXT_AFTER=#523 via #522. Does not implement #523–#529.
...
export const KNOWLEDGE_APPLICABILITY_NEXT_AFTER_CLOSE = "#523" as const;
