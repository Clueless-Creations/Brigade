 ...
 *
 * Consumes #518–#520. Does not redo them. NEXT_AFTER=#524 via #523. Does not implement #524–#529.
...
export const KNOWLEDGE_APPLICABILITY_NEXT_AFTER_CLOSE = "#524" as const;
