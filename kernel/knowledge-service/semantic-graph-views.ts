 ...
 * + kernel/engine/inference-invalidation.ts). NEXT_AFTER=#524 via #523. NO_524_IMPL cleared by #524. Does not implement #525–#529.
 *
...
export const SEMANTIC_GRAPH_VIEWS_NEXT_AFTER_CLOSE = "#525" as const;
