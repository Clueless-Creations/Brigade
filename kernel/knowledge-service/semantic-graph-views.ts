 ...
 * + kernel/engine/inference-invalidation.ts). NEXT_AFTER=#524 via #523. Does not implement #524–#529.
 *
...
export const SEMANTIC_GRAPH_VIEWS_NEXT_AFTER_CLOSE = "#524" as const;
