 ...
 * + kernel/engine/inference-invalidation.ts). NEXT_AFTER=#524 via #523. NO_524_IMPL cleared by #524. NO_525_IMPL cleared by #525. NO_526_IMPL cleared by #526. NO_527_IMPL cleared by #527. Does not implement #528–#529.
 *
...
export const SEMANTIC_GRAPH_VIEWS_NEXT_AFTER_CLOSE = "#528" as const;
