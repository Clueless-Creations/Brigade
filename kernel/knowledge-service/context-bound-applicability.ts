 ...
 *
 * NEXT_AFTER=#524 via #523. NO_524_IMPL cleared by #524. Does not implement #525–#529. No founder decision logic.
...
export const CONTEXT_BOUND_APPLICABILITY_NEXT_AFTER_CLOSE = "#525" as const;
