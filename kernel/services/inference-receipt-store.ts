 ...
 * invalidation/erasure with kernel/engine + kernel/reducer. Consumes through #521 (SQ-09 applicability). NO_522_IMPL cleared by #522. NO_523_IMPL cleared by #523. NO_524_IMPL cleared by #524. NO_525_IMPL cleared by #525. NO_526_IMPL cleared by #526. NO_527_IMPL cleared by #527. Does not implement #528–#529.
...
export const INFERENCE_RECEIPT_STORE_NO_522_IMPL = false as const;
export const INFERENCE_RECEIPT_STORE_NO_523_IMPL = false as const;
...
export const INFERENCE_RECEIPT_STORE_NEXT_AFTER_CLOSE = "#528" as const;
