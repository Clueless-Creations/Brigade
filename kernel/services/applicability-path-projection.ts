 ...
 * NEXT_AFTER=#524 via #523. NO_524_IMPL cleared by #524. NO_525_IMPL cleared by #525. Does not implement #526–#529.
 */
...
export const APPLICABILITY_PATH_PROJECTION_NEXT_AFTER_CLOSE = "#526" as const;
