...
Issue 77 is closed on main through #181. Overlay `order` stays a checked transcription.
...
[complexity-sample.md](./complexity-sample.md) supports keeping that form:
existing fields suffice. Not a runtime gate. Do not add questions, a policy
database, or a schema expansion.
