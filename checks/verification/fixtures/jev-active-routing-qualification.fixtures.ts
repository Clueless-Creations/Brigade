...
export function register(harness: Harness): void {
  harness.check("jev-active-routing-qualification: stamps + AC map + hard bans + NO_571 cleared", () => {
    ...
    assert(JEV_ROUTING_NEXT_AFTER_CLOSE === "#574" && SERVICE_NEXT === "#574" && JEV_ROUTING_RECIPE_NEXT_AFTER_CLOSE === "#574", "next");
    assert(JEV_ROUTING_NO_573_IMPL === false && SERVICE_NO_573 === false && JEV_ROUTING_RECIPE_NO_573_IMPL === false, "NO_573 cleared");
