 ...
 *
 * Also: NO_521_IMPL cleared on #520 stamps; NEXT_AFTER advanced to #528 by #522; no network-in-reads.
 */
...
export function register(harness: Harness): void {
  harness.check("knowledge-applicability: stamp/issue/consumes + AC map + hard bans + NO_521 cleared", () => {
    ...
    assert(KNOWLEDGE_APPLICABILITY_NEXT_AFTER_CLOSE === "#511", "map next #511");
    assert(CONTEXT_BOUND_APPLICABILITY_NEXT_AFTER_CLOSE === "#511", "module next #511");
