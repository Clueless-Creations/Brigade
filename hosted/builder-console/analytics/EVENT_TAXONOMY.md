...
| 2   | `signin_started`         | console   | The user clicks a provider button on /signin, before the redirect                       | `method` (`google` or `github`), `entry_point` (`landing`, `console_guard`, `pricing`)                                                                                                                                      | every click                      |
