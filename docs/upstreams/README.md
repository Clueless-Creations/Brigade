...
- [TaskGrind qualification hold (#213)](taskgrind-qualification.md) — Phase-1 hold (authoritative access unavailable); provider-neutral operator-assisted human-beta handoff only; no speculative adapter; live recruit not performed.
