...
| Understand Product Profile truth, intended/observed models, and bounded retrieval | [Product Profile contract](contracts/product-profile/README.md) and [ADR-0019](decisions/0019-product-profile-truth-ownership.md) |\n| Understand founder authority grants   | [Authority envelopes](authority-envelopes.md)                                                                                                                        |
...
| Understand proposed semantic execution | [Working model](semantic-execution.md), [ADR-0016](decisions/0016-compiled-semantic-execution.md), and [delivery plan](plans/2026-09-17-compiled-semantic-execution.md) |
