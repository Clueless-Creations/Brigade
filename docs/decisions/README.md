...
| [0020](0020-provider-neutral-console-identity.md) | Provider-neutral hosted console identity (no email-only merge) | Decision A accepted; Decision B proposed | Hosted D1 identity; console OAuth; #6 |
